...
const Sidebar = ({ isOpen, onClose, isCollapsed, onToggleCollapse, onMenuClick }) => {
  const { user } = useAuth();
  const { currentBatch, setCurrentBatch, customBatches, addCustomBatch, removeCustomBatch, batches, addBatch } = useStudents();
  ...
  const handleAddBatch = () => {
    ...
    try {
      ...
      setBatchError('Failed to add batch. Please try again.');
    } finally {
