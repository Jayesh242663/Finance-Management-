...
const StudentList = () => {
  const { payments, deleteStudent, getFilteredStudents, currentBatch, loading, courses } = useStudents();
                  ...
                  <tr key={student.id} className="table-row">
                    ...
                    <td data-label="Course">
                      <span className="course-name">
                        {courseOptions.find((c) => c.value === student.course)?.label || student.course}
                      </span>
                    </td>
