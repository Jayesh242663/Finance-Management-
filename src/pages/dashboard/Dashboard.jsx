...
const Dashboard = () => {
  const { getStats, getFilteredStudents, getFilteredPayments, currentBatch, placements, loading } = useStudents();
  const { user } = useAuth();
  ...
  const shouldShowSkeleton = loading && students.length === 0 && payments.length === 0;
  ...
  return (
    <div className="dashboard">
              ...
              <div className="navbar-dropdown">
                <div className="navbar-dropdown-header">
                  ...
                  <div className="navbar-dropdown-info">
                    ...
                    <p className="email">{user?.email || 'user@dsmct.com'}</p>
      ...
      <div style={{ display: shouldShowSkeleton ? 'none' : 'block' }}>
